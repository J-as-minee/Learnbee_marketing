...
const ARROW_CLASSES =
  "relative flex items-center justify-center rounded-full border-[1.5px] border-black/15 bg-white text-black/70 cursor-pointer shrink-0 z-30 outline-none shadow-[0_4px_20px_rgba(0,0,0,0.14)] hover:border-[#9333EA] hover:text-[#9333EA] active:opacity-70 transition-colors duration-300";
      ...
      {needsPagination && (
        <div className="flex items-center justify-center gap-4 mt-4 md:mt-6 z-30">
          ...
          <div className="flex items-center gap-2">
            {cards.map((_, i) => (
              <span key={i} className={`w-2 h-2 rounded-full transition-all duration-300 ${i === centerIndex ? "bg-[#9333EA] scale-[1.4]" : "bg-black/20"}`} />
            ))}
          </div>
